...
def runitt():
    ...
    process0='./zenbot.sh trade --max_slippage_pct=5 --order_adjust_time=5750 --trend_ema=13 --neutral_rate=0 --oversold_rsi_periods=25 --oversold_rsi=11 --max_sell_loss_pct=0 --avg_slippage_pct=0.1 poloniex.' + variablestr
