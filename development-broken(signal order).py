...
def buybuy():
    ...
    process1='./zenbot.sh buy --order_adjust_time=20000000000000 --markup_pct=-0.25  poloniex.' + variablestr	
...
def sellsell():
    ...
    process1='./zenbot.sh sell --order_adjust_time=20000000000000 --markup_pct=0 --debug  poloniex.' + variablestr	
    subprocess.call(process1,shell=True)
